...
export default function PipelineColumn({
  ...
  return (
    <div
      className={`flex-shrink-0 w-64 flex flex-col rounded-2xl border border-[#E5CB90]/50 border-t-4 ${cfg.border} bg-white transition-all duration-200 ${isDragOver ? "ring-2 ring-[#458393]/40 shadow-lg scale-[1.01]" : ""}`}
    ...
    >
      ...
      <div className={`px-3.5 py-3 rounded-t-xl ${cfg.bg}`}>
        <div className="flex items-center justify-between mb-1">
          ...
          >
            ...
            <span className="text-xs font-medium text-white rounded-full px-2 py-0.5"
      ...
      <AnimatePresence>
        {!collapsed && (
          ...
          >
            {leads.length === 0 && (
              <div className={`flex-1 flex items-center justify-center rounded-xl border-2 border-dashed border-[#E5CB90]/50 min-h-[100px] text-[#5C6D71] text-xs transition-colors ${isDragOver ? "bg-[#FFF3C8]/40 border-[#458393]/40" : ""}`}>
