    ...
    <Card>
      ...
      <div className="flex flex-col gap-2">
        {actions.map(({ icon: Icon, label,href }) => (
          <a className="flex items-center gap-2 bg-[#FFF3C8]/40 border border-[#E5CB90]/60 rounded-lg px-3 py-2.5 text-sm text-[#22303A] hover:bg-[#FFF3C8] transition-colors"href={href}>
          <button
            key={label}
